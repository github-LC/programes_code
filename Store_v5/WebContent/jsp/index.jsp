				...
				<div class="col-md-10">
					...
					<c:forEach items="${list01 }" var="list">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="ProductServlet?method=product_info&id=${list.pid }"">
								<img src="${list.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="ProductServlet?method=product_info&id=${list.pid }" style='color:#666'>${list.pname }</a></p>
							<p><font color="#E4393C" style="font-size:16px">&yen;${list.shop_price }</font></p>
						</div>
					</c:forEach>
