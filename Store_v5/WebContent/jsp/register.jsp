...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="UserServlet?method=regist" method="post">
			 ...
			 <div class="form-group">
			  ...
			  <input type="radio" id="inlineRadio1" name="sex" checked="checked" value="男"> 男
			</label>
			<label class="radio-inline">
