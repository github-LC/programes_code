...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010201','0102','分类管理','${pageContext.request.contextPath}/AdminCategoryServlet?method=getAllCategory','','mainFrame');
		d.add('0104','01','商品管理');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findProductsWithPage&currentPage=1','','mainFrame');
