						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<c:forEach items="${order }" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="5%">
													...
													<c:if test="${o.state==2 }"><a href="AdminOrderServlet?method=updateOrderState&oid=${o.oid }">发货</a></c:if>
	...
	<script>
		$(function(){
			$(".btn").click(function(){
				...
				var obj = {"method":"findOrderWithId","id":id};
