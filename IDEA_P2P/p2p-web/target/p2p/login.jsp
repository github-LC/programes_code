      ...
      <div class="login-cnt clearfix">
        <div class="login-form">
		     ...
		     <label>密码</label>
                 ...
                 <div id="loginPasswordErr" class="form-hint" style="display:none;"></div>
		     </div>

            <label style="padding-top: 23px">验证码</label>
		     <div class="login-yzm">
        ...
        <div class="login-right">
          ...
          <div class="bn-reg" id="quickRegBtn">
            <button onclick="location.href='${pageContext.request.contextPath}/loan/regist'">马上注册</button>
          </div>
           ...
           <ul class="clearfix">
            <li><i></i>
              <h3>优选投资计划</h3>
              <p>
              	历史年化收益<span>${historyAverageRate}%</span><br/>
