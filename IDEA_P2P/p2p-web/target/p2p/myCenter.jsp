        ...
        <div class="credenMain clearfix">
            ...
            <div class="credenBasic">
                <div class="credenName">
                    <div class="head">
                    <span><img id="user_photo" src="images/header.png" width="90" height="90"/></span>
                    <a href="loan/uploadHeader">上传头像</a>
                    </div>
                    <h3 class="name">
                    <c:choose>
                    <c:when test="${empty user.name}">
                   		<a href="realName.jsp">请认证姓名</a>
                    </c:when>
                    <c:otherwise>
						${user.name}                    
                    </c:otherwise>
                ...
                <i class="borderRight"></i>
                 <ul class="credenBalance">
                  <li class="availMoney">
	                  ...
	                  <a class="recharge" href="toRecharge.jsp">充值</a>
        ...
        <div class="allInvest clearfix">
            <div class="eachInvest invest-tab">
                ...
                <div class="invest-tab-box">
                 ...
                 <div class="more-allinvest">
                     <a href="loan/myInvest"><span>查看全部投资</span><i></i></a>
                 </div>
             </div>
            </div>
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                 ...
                 <div class="more-allinvest">
                    <a href="loan/myRecharge"><span>查看全部充值</span><i></i></a>
                </div>
            </div>
            ...
            <div class="eachInvest recent-earnings">
                ...
                <div id="moreRecentIncome" class="more-allinvest">
                    <a href="loan/myIncome"><span>查看全部收益计划</span><i></i></a>
                </div>
            </div>
        </div>
        <!--最新操作数据end-->
