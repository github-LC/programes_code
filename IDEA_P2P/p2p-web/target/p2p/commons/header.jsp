...
<div class="headBody" id="headBody">
    ...
    <div class="mainBox clearfix">
        <div class="head_l"><span>客服电话：400-8080-105</span><em></em><a href="https://weibo.com/u/5206191309?is_all=1" target="_blank" class="weibo"></a></div>
        <div class="head_r"><a href="helpcenter.jsp" id="helpcenter.jsp">帮助中心</a><em></em><a href="phone.jsp" id="/webPage/invest/phone_jinxin.html" class="phone_jinxin" style="margin-right:15px;"><i></i>手机客户端</a>
    ...
    <div class="headCnt clearfix">
        <div class="logo"><a href="${pageContext.request.contextPath}"><img src="${pageContext.request.contextPath}/images/logo.png" style="width:140px;height:60px" alt="图片加载失败"/></a></div>
        <ul class="main-nav">
            <li><h2><a id="jinxin" href="${pageContext.request.contextPath}">首页<i></i></a></h2></li><!--current为当前状态-->
            <li>
            	<h2><a id="wytz" href="loan/loan?currentPage=1">我要投资<i></i></a></h2>
        ...
        <c:when test="${empty user}">
          	<!-- 未登录start -->
          	<div class="no-login"><a href="loan/regist" class="btn-reg">注册</a><a href="${pageContext.request.contextPath}/login" class="btn-login">登录</a></div>
          	<!-- 未登录end -->
        </c:when>
        <c:otherwise>
           <!--登录后begin-->
...
<div id="ewm" class="ewm_layer" style="display:none;">
    ...
    <div class="ewm_weixin">
        <h3>马上理财网服务号</h3>
        <h4>更多服务请关注马上理财网服务号</h4>
        <div class="ewm"><img src="images/ewm_fwh.jpg" alt="马上理财网服务号"></div>
    </div>
    <div class="ewm_weixin">
        <h3>马上理财网订阅号</h3>
        <h4>获取马上理财网最新资讯</h4>
        <div class="ewm"><img src="images/ewm_dyh.jpg" alt="马上理财网订阅号"></div>
    </div>
</div>
<!-- 二维码弹出层end -->