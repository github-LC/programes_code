          ...
          <div class="investMain">
            ...
            <div class="investContent">
              <div class="investOver clearfix" id = "banks2">
                <label>
			   	<form id="alipayForm" action="${pageContext.request.contextPath}/loan/toAlipayRecharge" method="post" target="_blank">
                ...
                <label>
                <form id="wxpayForm" action="${pageContext.request.contextPath}/loan/toWxpayRecharge" method="post" target="_blank">
