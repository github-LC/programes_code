 ...
 <div class="homeWap">
  <div class="fund-guanli clearfix">
   ...
   <div class="right-body">
    <div class="leftTitle"><span class="on">微信支付二维码</span></div>
    
    <div class="unrecognized" style = "display:block;" id="unrecognized1">
     <h4>充值记录编号：${rechargeNo} &nbsp;&nbsp;&nbsp;&nbsp; 充值金额：${rechargeMoney} &nbsp;&nbsp;&nbsp;&nbsp; 描述：${body}</h4>
     <img src="${pageContext.request.contextPath}/loan/showQRCode?rechargeNo=${rechargeNo}&rechargeMoney=${rechargeMoney}&body=${body}"  alt="图片加载失败"/>
    </div>
   </div>
  </div>      
 </div>
